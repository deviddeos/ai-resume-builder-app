import { FilePenLine, FilePenLineIcon, PencilIcon, PlusIcon, Trash, UploadCloudIcon, XIcon } from 'lucide-react'
    ...
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4'>
          ...
          <button className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
        ...
        {showCreateResume && (
          <form onSubmit={createResume} onClick={() => setShowCreateResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <input type='text' placeholder='Enter resume title' className='w-full px-4 mb-4 focus:border-green-600 ring-green-600' required />

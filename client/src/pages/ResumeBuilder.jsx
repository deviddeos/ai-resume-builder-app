...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, Share2, Share2Icon, Sparkle, Sparkles, User } from 'lucide-react'
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            ...
            <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
              ...
              <div className='flex items-center gap-2'>
                {/* change template and accent color buttons */}
